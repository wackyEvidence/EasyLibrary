...
const Navbar = () => {
    return (
        <nav class="navbar navbar-expand-lg bg-body-tertiary n-secondary">
            <div class="container-fluid">
                <svg xmlns="http://www.w3.org/2000/svg" height="36" viewBox="0 -960 960 960" width="36" fill="#E2D4BA">
                    <path
                ...
                <a class="navbar-brand ms-2 me-3 fs-2" href="/">EasyLibrary</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="d-flex flex-column align-items-center me-2">
                        ...
                        <Link class="nav-link p-0 fs-5" to="login">Войти</Link>
                    </div>
                </div>
            </div>
        </nav>
